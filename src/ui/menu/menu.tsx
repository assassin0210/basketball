    ...
    return (
        <div className={menu.menu_Container}>
            <div className={menu.wrapper_for_mod}>
                <div onClick={toggleSetTeamsMod}
                    ...
                    <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="group_person">
                            <path id="group_person_2" fillRule="evenodd" clipRule="evenodd"
                ...
                <div onClick={toggleSetPlayersMod}
                    ...
                    <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="person">
                            <path id="person_2" fillRule="evenodd" clipRule="evenodd"
            ...
            <div onClick={handleExit} className={`${menu.mod} ${menu.exit_button}`}>
                <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="input">
                        <path id="input_2" fillRule="evenodd" clipRule="evenodd"
